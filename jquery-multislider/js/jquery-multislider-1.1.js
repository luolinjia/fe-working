        ...
        var index = 1, flag = 1,
            ...
            settings = {
                ...
                getImgOffset: function () {
                    var currentWidth = o.parent().innerWidth(), imgWidth = $('.inner', o).find('img').innerWidth(), result = parseInt(imgWidth) - parseInt(currentWidth);
                 ...
                 */
                bgAnimate: function () {
                    var os = $('.outer', o).find('.inner'), osLine = $('.outer', o).find('.inner-line'), ios = os.parent(), offsetLR = 0;
                    _.initBanner();
                    offsetLR = _.getImgOffset();
                    if (settings.aDirection === 'RTL') {
                        os.css({'right': -offsetLR}); osLine.css({'right': -offsetLR});
                    } else {
                        os.css({'left': -offsetLR}); osLine.css({'left': -offsetLR});
                    }
                    if (index === 1 && flag === 1) {
